...
const POINT_TX = {
  ...
  'ptx-bob-02':    { user_id:'user-linked-bob',   amount:700,  type:'daily_visit',reason:'일일 방문 누적 보상',       created_at:ago(3)  },
  'ptx-dave-01':   { user_id:'user-guest-dave',   amount:100,  type:'daily_visit',reason:'일일 방문 보상',           created_at:ago(2)  },
};
